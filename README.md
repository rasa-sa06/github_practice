...
このリポジトリはプロジェクトの一部（ホームページ）です。
提案書には受注管理システムも含まれています。
**全体像と、どこまで作ったかは [`docs/project-map.md`](docs/project-map.md) にまとめています。**
...
| `docs/` | プロジェクト全体像、依頼者への確認事項、Instagram 連携の設定手順 |
